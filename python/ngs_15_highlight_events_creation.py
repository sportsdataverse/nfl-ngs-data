"""Stage 15 -- highlight_events -> release tag ``nfl_ngs_highlight_events``.
...
directory listing. Equivalent to::
    ...
    python -m ngs_data_build --dataset highlight_events -s <start> -e <end> [--publish]
"""
