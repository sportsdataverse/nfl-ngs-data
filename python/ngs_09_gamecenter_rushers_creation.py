"""Stage 09 -- gamecenter_rushers -> release tag ``nfl_ngs_gamecenter_rushers``.
...
directory listing. Equivalent to::
    ...
    python -m ngs_data_build --dataset gamecenter_rushers -s <start> -e <end> [--publish]
"""
