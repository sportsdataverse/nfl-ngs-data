"""Stage 10 -- gamecenter_receivers -> release tag ``nfl_ngs_gamecenter_receivers``.
...
directory listing. Equivalent to::
    ...
    python -m ngs_data_build --dataset gamecenter_receivers -s <start> -e <end> [--publish]
"""
