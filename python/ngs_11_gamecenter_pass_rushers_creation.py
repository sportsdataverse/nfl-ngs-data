"""Stage 11 -- gamecenter_pass_rushers -> release tag ``nfl_ngs_gamecenter_pass_rushers``.
...
directory listing. Equivalent to::
    ...
    python -m ngs_data_build --dataset gamecenter_pass_rushers -s <start> -e <end> [--publish]
"""
...
DATASET = "gamecenter_pass_rushers"
