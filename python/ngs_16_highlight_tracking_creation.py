"""Stage 16 -- highlight_tracking -> release tag ``nfl_ngs_highlight_tracking``.
...
directory listing. Equivalent to::
    ...
    python -m ngs_data_build --dataset highlight_tracking -s <start> -e <end> [--publish]
"""
