"""Stage 14 -- highlight_participation -> release tag ``nfl_ngs_highlight_participation``.
...
directory listing. Equivalent to::
    ...
    python -m ngs_data_build --dataset highlight_participation -s <start> -e <end> [--publish]
"""
...
DATASET = "highlight_participation"
